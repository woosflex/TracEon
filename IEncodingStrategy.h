...
// Enum for data type hints to help the strategy choose the right encoding
...
public:
    ...
    virtual std::vector<unsigned char> encode(const std::string& data, DataTypeHint hint = DataTypeHint::Generic) const = 0;
